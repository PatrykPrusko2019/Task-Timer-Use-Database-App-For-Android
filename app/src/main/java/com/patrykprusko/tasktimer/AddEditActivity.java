...
public class AddEditActivity extends AppCompatActivity implements AddEditActivityFragment.OnSaveClicked,
    ...
    //dzieki temu dziala przycisk back button i wyswietla sie dialog wyboru
    @Override
    ...
    public void onBackPressed() {
        ...
        FragmentManager fragmentManager = getSupportFragmentManager();
        AddEditActivityFragment fragment = (AddEditActivityFragment) fragmentManager.findFragmentById(R.id.fragment); //zmieniamy na jaki korzysta content_main.xml w pozycji pionowej
        if( fragment.canClose() ) {
            super.onBackPressed();
        } else {
            showConfirmationDialog();
